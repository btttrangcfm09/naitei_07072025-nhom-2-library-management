...
public class WebExceptionHandler {
    ...
    public String handleConcurrencyException(
    ...
    public ResponseEntity<Map<String, String>> handleCannotDeleteResource(CannotDeleteResourceException ex,
            WebRequest request) {
    ...
    public ResponseEntity<Map<String, String>> handleBookInstanceNotFound(BookInstanceNotFoundException ex,
            WebRequest request) {
        Map<String, String> errorDetails = Map.of("error", ex.getMessage());
        return new ResponseEntity<>(errorDetails, HttpStatus.BAD_REQUEST);
    }
